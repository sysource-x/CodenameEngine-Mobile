            ...
            switch (cmd[i]) {
                ...
                case "-modfolder":
                    ...
                    if (arg == null) {
                        ...
                        Sys.exit(1);
                    } else if (LimeAssets.exists(arg)) { // Verifica se o caminho existe dentro dos assets internos
                        funkin.backend.assets.ModsFolder.modsPath = arg;
                    } else {
                        Sys.println('[ERROR] Mod folder at "${arg}" does not exist in assets.');
                        Sys.exit(1);
                    }
                case "-addonsfolder":
                    i++;
                    ...
                    if (arg == null) {
                        ...
                        Sys.println('[ERROR] Addons folder at "${arg}" does not exist in assets.');
                        Sys.exit(1);
                    }
                #end
                case "-nocolor":
